...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_pmsm_mech_ctrl_cffi(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_pmsm_mech_ctrl_cffi(void) { return NULL; }
#  else
     initpmsm_mech_ctrl_cffi(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit_pmsm_mech_ctrl_cffi(void)
{
  return _cffi_init("pmsm_mech_ctrl_cffi", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initpmsm_mech_ctrl_cffi(void)
{
  _cffi_init("pmsm_mech_ctrl_cffi", 0x2601, &_cffi_type_context);
}
#endif
