...
class pmsm_mech_ctrl_class: 
    ...
    def __init__(self): 
        ...
        self.outputs_list = ['u_d', 'u_q', 'tau_r_ref', 'v_pk', 'i_pk', 'omega_r', 'f_w', 'f_d', 'f_r', 'tau_r', 'p_r', 'nu_kmh'] 
...
def sp_jac_run_vectors():
    ...
    sp_jac_run_ia = [0, 1, 7, 8, 0, 1, 7, 9, 0, 1, 10, 4, 6, 11, 4, 5, 1, 6, 7, 12, 0, 1, 2, 7, 8, 0, 1, 3, 7, 9, 10, 10, 4, 11, 4, 12]
    sp_jac_run_ja = [0, 4, 8, 9, 11, 14, 16, 18, 20, 25, 31, 32, 34, 36]
    sp_jac_run_nia = 13
    sp_jac_run_nja = 13
